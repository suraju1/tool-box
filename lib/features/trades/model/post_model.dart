...
class PostModel {
  ...
  PostModel copyWith({
    ...
    String? returnItemCategory,
    String? returnItemCondition,
    String? returnItemDescription,
    String? returnItemSource,
    List<String>? returnItemImages,
    String? postType,
    String? returnType,
  }) {
    return PostModel(
      ...
      returnItemName: returnItemName ?? this.returnItemName,
      returnItemCategory: returnItemCategory ?? this.returnItemCategory,
      returnItemCondition: returnItemCondition ?? this.returnItemCondition,
      returnItemDescription: returnItemDescription ?? this.returnItemDescription,
      returnItemSource: returnItemSource ?? this.returnItemSource,
      returnItemImages: returnItemImages ?? this.returnItemImages,
